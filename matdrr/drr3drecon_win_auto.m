function [ D1 ] = drr3drecon_win_auto(D,mask,flow,fhigh,dt,N,K,Niter,eps,verb,mode,amode,a,eps2,n1win,n2win,n3win,r1,r2,r3)
%  DRR3DRECON_WIN: DRR3D in windows
%
%  IN   D:   	intput 3D data
...
D1=drr_win3dmask(@localdrr3drecon_auto, mask, param, D, n1win, n2win, n3win, r1, r2, r3);
