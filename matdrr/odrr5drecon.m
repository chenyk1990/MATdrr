function [ D1 ] = odrr5drecon(D,MASK,flow,fhigh,dt,N,K,O,Niter,eps,verb,mode,a)
%  ODRR5DRECON: Optimally damped rank-reduction method for 5D simultaneous denoising and reconstruction
%
%  IN   D:   	intput 5D data
