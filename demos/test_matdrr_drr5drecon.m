...
subplot(5,2,1);drr_imagesc(reshape(d(:,:,:,1,1),100,10*10),0.5,2,1:100,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('Clean'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'a)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');
subplot(5,2,3);drr_imagesc(reshape(dn(:,:,:,1,1),100,10*10),0.5,2,1:100,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('Noisy (SNR=',num2str(snrnn),' dB )'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'c)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');
subplot(5,2,5);drr_imagesc(reshape(d0(:,:,:,1,1),100,10*10),0.5,2,1:100,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('Incomplete (SNR=',num2str(snr00),' dB )'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'e)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');
subplot(5,2,7);drr_imagesc(reshape(d1(:,:,:,1,1),100,10*10),0.5,2,1:100,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('RR (SNR=',num2str(snr11),' dB )'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'g)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');
subplot(5,2,9);drr_imagesc(reshape(d2(:,:,:,1,1),100,10*10),0.5,2,1:100,t);xlabel('Offset trace','Fontsize',12,'fontweight','normal');ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('DRR (SNR=',num2str(snr22),' dB )'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'i)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');

subplot(5,2,2);drr_imagesc(reshape(d(:,5,5,:,:),100,10*10),0.5,2,1:100,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('Clean'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'b)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');
subplot(5,2,4);drr_imagesc(reshape(dn(:,5,5,:,:),100,10*10),0.5,2,1:100,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('Noisy (SNR=',num2str(snrnn),' dB )'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'d)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');
...
subplot(5,2,8);drr_imagesc(reshape(d1(:,5,5,:,:),100,10*10),0.5,2,1:100,t);ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('RR (SNR=',num2str(snr11),' dB )'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'h)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');
subplot(5,2,10);drr_imagesc(reshape(d2(:,5,5,:,:),100,10*10),0.5,2,1:100,t);xlabel('Midpoint trace','Fontsize',12,'fontweight','normal');ylabel('Time (s)','Fontsize',12,'fontweight','normal');set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','normal');title(strcat('DRR (SNR=',num2str(snr22),' dB )'),'Fontsize',15,'fontweight','normal');text(-9,-0.1,'j)','color','k','Fontsize',24,'fontweight','bold','HorizontalAlignment','left');

print(gcf,'-dpng','-r300','test_matdrr_drr5drecon.png');
print(gcf,'-depsc','-r200','test_matdrr_drr5drecon.eps');
